      ...
      <section class="pg-tabla-cuerpo" aria-labelledby="cc-listado-cartera-tit">
        ...
        >
          <li v-for="c in cuentasFiltradas" :key="c.id" role="listitem">
            <button type="button" class="cc-cartera-tarjeta" @click="abrirMovimientosCliente(c)">
        ...
        <p v-else class="cc-cartera-vacio" role="status">
          ...
          <template v-else>
            Ningún cliente coincide con los filtros elegidos. Probá otro nombre o cambiá el estado de
            deuda.
          </template>
        </p>
