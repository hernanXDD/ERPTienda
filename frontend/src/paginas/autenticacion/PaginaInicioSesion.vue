...
<template>
  <div class="pagina">
    <main class="panel" aria-labelledby="titulo-login">
      ...
      <p class="descripcion">ERP tienda — entorno de desarrollo con autenticación simulada.</p>
      ...
      <p class="ayuda">
        Prueba: <code>admin</code>/<code>admin</code>,
        <code>dueño</code>/<code>dueño</code> o empleado
        <code>empleado</code>/<code>empleado</code> (ideal para permisos sin rol elevado).
      </p>
    </main>
  </div>
</template>
