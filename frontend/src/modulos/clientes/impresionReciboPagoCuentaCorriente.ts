...
<style>
body{font-family:system-ui,sans-serif;margin:2rem;line-height:1.45;color:#0f172a;max-width:40rem}
h1{font-size:1rem;margin:0 0 .25rem;font-weight:700;color:#334155;text-transform:uppercase;letter-spacing:.05em}
${estilosEmisorReporteInlineCss}
...
<header>${bloqueEmisor}<p class="sub">Comprobante interno de registro de pago.</p></header>
<div class="rec">
